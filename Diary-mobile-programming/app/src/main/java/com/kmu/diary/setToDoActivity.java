...
public class setToDoActivity extends AppCompatActivity {

    private DB_todo mydb;
    TextView date;
    TextView content;
    int id = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            if (Value > 0) {
                ...
                id = Value;
                rs.moveToFirst();
                String d = rs.getString(rs.getColumnIndex(DB_todo.TODO_COLUMN_DATE));
                String c = rs.getString(rs.getColumnIndex(DB_todo.TODO_COLUMN_CONTENT));
                if (!rs.isClosed()) {
                    rs.close();
                }
